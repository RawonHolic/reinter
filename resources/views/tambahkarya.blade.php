        ...
        <div class="col-lg-5 m-t-md">
          <div class="ibox float-e-margins">
            <div class="ibox-title">
              <h5 class="pull-right" style="font-size: 15px">Tambah Karya</h5>
            </div>
                      ...
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <p>
                              Apakah anda yakin untuk <strong>Membatalkan Menyimpan</strong> karya baru? Pilih batal untuk kembali ke halaman karya
                            </p>
                          </div>

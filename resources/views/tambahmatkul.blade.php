        ...
        <div class="col-lg-5 m-t-md">
          <div class="ibox float-e-margins">
            <div class="ibox-title">
              <h5 class="pull-right" style="font-size: 15px">Tambah Mata Kuliah</h5>
            </div>
            <div class="ibox-content">
              <form method="get" class="form-horizontal">
                <div class="form-group"><label class="col-sm-2 control-label">Nama Mata Kuliah</label>
                ...
                <div class="hr-line-dashed"></div>
                <div class="form-group"><label class="col-sm-2 control-label">SKS</label>
                  <div class="col-sm-10"><input type="text" class="form-control"></div>
                </div>
                <div class="hr-line-dashed"></div>
                ...
                <div class="hr-line-dashed"></div>
                <div class="form-group"><label class="col-sm-2 control-label">Dosen Pengampu</label>
                  <div class="col-sm-10">
                    <select class="form-control m-b" name="account">
                      <option>Belum ada</option>
                      <option>Tito Pangesti Adji</option>
                      <option>Septadi Hanif Pambayu</option>
                      <option>Muhammad Bagus Binathara</option>
                      <option>Muhammad Nurul Akbar Adityatama</option>
                      <option>Oktavian Arianto</option>
                    </select>
                  </div>
                </div>
                <div class="hr-line-dashed"></div>
                      ...
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-white" data-dismiss="modal">Lanjut Tambah</button>
